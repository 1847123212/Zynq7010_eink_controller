...
module config_reg_ed108 #(
    ...
    //edid par  1920x1080 PixClk 165Mhz
        ...
        150 : REG_DATA  =   {8'd3, 8'h6c, 8'd100,8'h20, 8'h00};
        151 : REG_DATA  =   {8'd3, 8'h6c, 8'd101,8'h20, 8'h00};
        152 : REG_DATA  =   {8'd3, 8'h6c, 8'd102,8'h20, 8'h00};
        153 : REG_DATA  =   {8'd3, 8'h6c, 8'd103,8'h0A, 8'h00};
        154 : REG_DATA  =   {8'd3, 8'h6c, 8'd104,8'h20, 8'h00};
        155 : REG_DATA  =   {8'd3, 8'h6c, 8'd105,8'h20, 8'h00};
        156 : REG_DATA  =   {8'd3, 8'h6c, 8'd106,8'h20, 8'h00};
        157 : REG_DATA  =   {8'd3, 8'h6c, 8'd107,8'h20, 8'h00};
        ...
        161 : REG_DATA  =   {8'd3, 8'h6c, 8'd111,8'hFD, 8'h00};
        162 : REG_DATA  =   {8'd3, 8'h6c, 8'd112,8'h00, 8'h00};
        163 : REG_DATA  =   {8'd3, 8'h6c, 8'd113,8'h32, 8'h00};
        164 : REG_DATA  =   {8'd3, 8'h6c, 8'd114,8'h55, 8'h00};
        165 : REG_DATA  =   {8'd3, 8'h6c, 8'd115,8'h1F, 8'h00};
        166 : REG_DATA  =   {8'd3, 8'h6c, 8'd116,8'h45, 8'h00};
        167 : REG_DATA  =   {8'd3, 8'h6c, 8'd117,8'h0F, 8'h00};
        168 : REG_DATA  =   {8'd3, 8'h6c, 8'd118,8'h00, 8'h00};
        169 : REG_DATA  =   {8'd3, 8'h6c, 8'd119,8'h0A, 8'h00};
        170 : REG_DATA  =   {8'd3, 8'h6c, 8'd120,8'h20, 8'h00};
        171 : REG_DATA  =   {8'd3, 8'h6c, 8'd121,8'h20, 8'h00};
        172 : REG_DATA  =   {8'd3, 8'h6c, 8'd122,8'h20, 8'h00};
        173 : REG_DATA  =   {8'd3, 8'h6c, 8'd123,8'h20, 8'h00};
        174 : REG_DATA  =   {8'd3, 8'h6c, 8'd124,8'h20, 8'h00};
        175 : REG_DATA  =   {8'd3, 8'h6c, 8'd125,8'h20, 8'h00};
        176 : REG_DATA  =   {8'd3, 8'h6c, 8'd126,8'h01, 8'h00};
        177 : REG_DATA  =   {8'd3, 8'h6c, 8'd127,8'h24, 8'h00};
        // EDID END
