...
HD_PWD='C:/Users/Admin/Desktop/Zynq7010_eink_controller/controller/Z7_Lite/iLA/iLA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log iLA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source iLA.tcl -notrace
