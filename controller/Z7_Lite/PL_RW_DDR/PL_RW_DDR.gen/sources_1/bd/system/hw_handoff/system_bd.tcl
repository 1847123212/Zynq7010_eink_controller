...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net uiFDMA_0_M_AXI [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins uiFDMA_0/M_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports ui_clk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_150M/slowest_sync_clk] [get_bd_pins uiFDMA_0/M_AXI_ACLK]
  ...
  connect_bd_net -net rst_ps7_0_150M_peripheral_aresetn [get_bd_ports fdma_rstn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins rst_ps7_0_150M/peripheral_aresetn] [get_bd_pins uiFDMA_0/M_AXI_ARESETN]
