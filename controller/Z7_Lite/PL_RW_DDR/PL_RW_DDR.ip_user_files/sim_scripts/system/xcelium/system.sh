...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../PL_RW_DDR.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../PL_RW_DDR.gen/sources_1/bd/system/ipshared/34f8/hdl" \
       +incdir+"$ref_dir/../../../../PL_RW_DDR.gen/sources_1/bd/system/ipshared/d0f7" \
       +incdir+"../../../../PL_RW_DDR.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../PL_RW_DDR.gen/sources_1/bd/system/ipshared/34f8/hdl" \
       +incdir+"../../../../PL_RW_DDR.gen/sources_1/bd/system/ipshared/d0f7" \
