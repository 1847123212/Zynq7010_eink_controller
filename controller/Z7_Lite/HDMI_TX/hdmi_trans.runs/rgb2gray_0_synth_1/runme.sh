...
HD_PWD='C:/Users/Admin/Desktop/Zynq7010_eink_controller/controller/Z7_Lite/Lab11_FPGA_hdmi_img/hdmi_trans.runs/rgb2gray_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb2gray_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb2gray_0.tcl
