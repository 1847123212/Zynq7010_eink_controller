...
#
# Generated by export_simulation on Fri Oct 22 15:42:12 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './rgb2gray_0.sh' script.

./rgb2gray_0.sh -reset_run
...
./rgb2gray_0.sh -noclean_files

For more information on the script, please type './rgb2gray_0.sh -help'.
