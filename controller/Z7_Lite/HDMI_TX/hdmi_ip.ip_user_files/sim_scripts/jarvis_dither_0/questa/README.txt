...
#
# Generated by export_simulation on Wed Oct 13 08:55:49 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './jarvis_dither_0.sh' script.

./jarvis_dither_0.sh -reset_run
...
./jarvis_dither_0.sh -noclean_files

For more information on the script, please type './jarvis_dither_0.sh -help'.
