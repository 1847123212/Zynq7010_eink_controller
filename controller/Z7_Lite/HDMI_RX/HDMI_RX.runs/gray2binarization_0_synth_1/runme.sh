...
HD_PWD='C:/Users/Admin/Desktop/Zynq7010_eink_controller/controller/Z7_Lite/HDMI_RX/HDMI_RX.runs/gray2binarization_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gray2binarization_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gray2binarization_0.tcl
