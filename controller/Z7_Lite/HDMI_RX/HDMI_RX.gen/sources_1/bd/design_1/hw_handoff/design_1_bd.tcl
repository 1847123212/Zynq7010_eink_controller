...
proc create_root_design { parentCell } {
  ...
  set EDID_RX [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 EDID_RX ]
  ...
  connect_bd_intf_net -intf_net dvi2rgb_0_DDC [get_bd_intf_ports EDID_RX] [get_bd_intf_pins dvi2rgb_0/DDC]
  ...
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins dvi2rgb_0/aRst_n] [get_bd_pins dvi2rgb_0/pRst_n] [get_bd_pins rgb2dvi_0/aRst_n]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_ports HDMI_RX_HPA] [get_bd_pins xlconstant_0/dout]
