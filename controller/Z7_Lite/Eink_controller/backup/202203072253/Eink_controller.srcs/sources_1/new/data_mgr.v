...
//////////////////////////////////////////////////////////////////////////////////
//
//  这是一个并行数据管理器,用于自动请求FIFO中的数据并转换成屏幕所需的长度
//
//////////////////////////////////////////////////////////////////////////////////
...
module data_mgr#
    ...
    level2pulse #(.MODE("RISING")) newline_flag (.clk(clk), .rst_n(rst_n), .in(data_ren), .out(sw_line));

    assign fifo_ren = fifo_rflag || sw_line;
