module config_reg #(
    ...
    //write Data Index       len    addr  data_0 data_1 data_2
        ...
        9   : REG_DATA  =   {8'd3, 8'h98, 8'h02, 8'hF2, 8'h00};  // Auto CSC, YCrCb out, Set op_656 bit
        10  : REG_DATA  =   {8'd3, 8'h98, 8'h03, 8'h40, 8'h00};  // 24 bit SDR 444 Mode 0
    ...
    //edid par
        ...
        60  : REG_DATA  =   {8'd3, 8'h6c, 8'd10, 8'h29, 8'h00};
        ...
        85  : REG_DATA  =   {8'd3, 8'h6c, 8'd35, 8'h25, 8'h00};
        86  : REG_DATA  =   {8'd3, 8'h6c, 8'd36, 8'hC8, 8'h00};
        87  : REG_DATA  =   {8'd3, 8'h6c, 8'd37, 8'h00, 8'h00};
        88  : REG_DATA  =   {8'd3, 8'h6c, 8'd38, 8'h61, 8'h00};
        89  : REG_DATA  =   {8'd3, 8'h6c, 8'd39, 8'h4F, 8'h00};
        ...
        122 : REG_DATA  =   {8'd3, 8'h6c, 8'd72, 8'h8C, 8'h00};
        123 : REG_DATA  =   {8'd3, 8'h6c, 8'd73, 8'h0A, 8'h00};
        124 : REG_DATA  =   {8'd3, 8'h6c, 8'd74, 8'hD0, 8'h00};
        125 : REG_DATA  =   {8'd3, 8'h6c, 8'd75, 8'h8A, 8'h00};
        126 : REG_DATA  =   {8'd3, 8'h6c, 8'd76, 8'h20, 8'h00};
        127 : REG_DATA  =   {8'd3, 8'h6c, 8'd77, 8'hE0, 8'h00};
        128 : REG_DATA  =   {8'd3, 8'h6c, 8'd78, 8'h2D, 8'h00};
        129 : REG_DATA  =   {8'd3, 8'h6c, 8'd79, 8'h10, 8'h00};
        130 : REG_DATA  =   {8'd3, 8'h6c, 8'd80, 8'h10, 8'h00};
        131 : REG_DATA  =   {8'd3, 8'h6c, 8'd81, 8'h3E, 8'h00};
        132 : REG_DATA  =   {8'd3, 8'h6c, 8'd82, 8'h96, 8'h00};
        133 : REG_DATA  =   {8'd3, 8'h6c, 8'd83, 8'h00, 8'h00};
        134 : REG_DATA  =   {8'd3, 8'h6c, 8'd84, 8'h80, 8'h00};
        135 : REG_DATA  =   {8'd3, 8'h6c, 8'd85, 8'h88, 8'h00};
        136 : REG_DATA  =   {8'd3, 8'h6c, 8'd86, 8'h42, 8'h00};
        137 : REG_DATA  =   {8'd3, 8'h6c, 8'd87, 8'h00, 8'h00};
        138 : REG_DATA  =   {8'd3, 8'h6c, 8'd88, 8'h00, 8'h00};
        139 : REG_DATA  =   {8'd3, 8'h6c, 8'd89, 8'h18, 8'h00};
        ...
        143 : REG_DATA  =   {8'd3, 8'h6c, 8'd93, 8'hFC, 8'h00};
        144 : REG_DATA  =   {8'd3, 8'h6c, 8'd94, 8'h00, 8'h00};
        145 : REG_DATA  =   {8'd3, 8'h6c, 8'd95, 8'h48, 8'h00};
        146 : REG_DATA  =   {8'd3, 8'h6c, 8'd96, 8'h44, 8'h00};
        147 : REG_DATA  =   {8'd3, 8'h6c, 8'd97, 8'h4D, 8'h00};
        148 : REG_DATA  =   {8'd3, 8'h6c, 8'd98, 8'h49, 8'h00};
        149 : REG_DATA  =   {8'd3, 8'h6c, 8'd99, 8'h20, 8'h00};
        150 : REG_DATA  =   {8'd3, 8'h6c, 8'd10, 8'h20, 8'h00};
        151 : REG_DATA  =   {8'd3, 8'h6c, 8'd10, 8'h20, 8'h00};
        152 : REG_DATA  =   {8'd3, 8'h6c, 8'd10, 8'h20, 8'h00};
        153 : REG_DATA  =   {8'd3, 8'h6c, 8'd10, 8'h0A, 8'h00};
        154 : REG_DATA  =   {8'd3, 8'h6c, 8'd10, 8'h20, 8'h00};
        155 : REG_DATA  =   {8'd3, 8'h6c, 8'd10, 8'h20, 8'h00};
        156 : REG_DATA  =   {8'd3, 8'h6c, 8'd10, 8'h20, 8'h00};
        157 : REG_DATA  =   {8'd3, 8'h6c, 8'd10, 8'h20, 8'h00};
        158 : REG_DATA  =   {8'd3, 8'h6c, 8'd10, 8'h00, 8'h00};
        159 : REG_DATA  =   {8'd3, 8'h6c, 8'd10, 8'h00, 8'h00};
        160 : REG_DATA  =   {8'd3, 8'h6c, 8'd11, 8'h00, 8'h00};
        161 : REG_DATA  =   {8'd3, 8'h6c, 8'd11, 8'hFD, 8'h00};
        162 : REG_DATA  =   {8'd3, 8'h6c, 8'd11, 8'h00, 8'h00};
        163 : REG_DATA  =   {8'd3, 8'h6c, 8'd11, 8'h32, 8'h00};
        164 : REG_DATA  =   {8'd3, 8'h6c, 8'd11, 8'h55, 8'h00};
        165 : REG_DATA  =   {8'd3, 8'h6c, 8'd11, 8'h1F, 8'h00};
        166 : REG_DATA  =   {8'd3, 8'h6c, 8'd11, 8'h45, 8'h00};
        167 : REG_DATA  =   {8'd3, 8'h6c, 8'd11, 8'h0F, 8'h00};
        168 : REG_DATA  =   {8'd3, 8'h6c, 8'd11, 8'h00, 8'h00};
        169 : REG_DATA  =   {8'd3, 8'h6c, 8'd11, 8'h0A, 8'h00};
        170 : REG_DATA  =   {8'd3, 8'h6c, 8'd12, 8'h20, 8'h00};
        171 : REG_DATA  =   {8'd3, 8'h6c, 8'd12, 8'h20, 8'h00};
        172 : REG_DATA  =   {8'd3, 8'h6c, 8'd12, 8'h20, 8'h00};
        173 : REG_DATA  =   {8'd3, 8'h6c, 8'd12, 8'h20, 8'h00};
        174 : REG_DATA  =   {8'd3, 8'h6c, 8'd12, 8'h20, 8'h00};
        175 : REG_DATA  =   {8'd3, 8'h6c, 8'd12, 8'h20, 8'h00};
        176 : REG_DATA  =   {8'd3, 8'h6c, 8'd12, 8'h01, 8'h00};
        177 : REG_DATA  =   {8'd3, 8'h6c, 8'd12, 8'h24, 8'h00};  // EDID END
