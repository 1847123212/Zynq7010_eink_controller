...
HD_PWD='C:/Users/Admin/Desktop/Zynq7010_eink_controller/controller/Z7_Lite/Eink_controller/Eink_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Eink_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Eink_controller.tcl
