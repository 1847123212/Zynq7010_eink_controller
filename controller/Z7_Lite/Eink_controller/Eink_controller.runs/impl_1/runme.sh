...
HD_PWD='C:/Users/Admin/Desktop/Zynq7010_eink_controller/controller/Z7_Lite/Eink_controller/Eink_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Eink_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Eink_controller.tcl -notrace
