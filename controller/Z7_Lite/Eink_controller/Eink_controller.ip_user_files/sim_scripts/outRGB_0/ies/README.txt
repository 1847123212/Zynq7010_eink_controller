...
#
# Generated by export_simulation on Tue Mar 01 00:14:35 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './outRGB_0.sh' script.

./outRGB_0.sh -reset_run
...
./outRGB_0.sh -noclean_files

For more information on the script, please type './outRGB_0.sh -help'.
