module config_reg #(
    ...
    //edid par  1200x825 PixClk 165Mhz
        ...
        104 : REG_DATA  =   {8'd3, 8'h6c, 8'd54, 8'h74, 8'h00};
        105 : REG_DATA  =   {8'd3, 8'h6c, 8'd55, 8'h40, 8'h00};
        ...
        134 : REG_DATA  =   {8'd3, 8'h6c, 8'd84, 8'hb4, 8'h00};
        135 : REG_DATA  =   {8'd3, 8'h6c, 8'd85, 8'h78, 8'h00};
        136 : REG_DATA  =   {8'd3, 8'h6c, 8'd86, 8'h00, 8'h00};
        ...
        150 : REG_DATA  =   {8'd3, 8'h6c, 8'd100,8'h0a, 8'h00};
        151 : REG_DATA  =   {8'd3, 8'h6c, 8'd101,8'h20, 8'h00};
        152 : REG_DATA  =   {8'd3, 8'h6c, 8'd102,8'h20, 8'h00};
        153 : REG_DATA  =   {8'd3, 8'h6c, 8'd103,8'h20, 8'h00};
        ...
        177 : REG_DATA  =   {8'd3, 8'h6c, 8'd127,8'hc7, 8'h00};  // EDID END
