...
HD_PWD='C:/Users/Admin/Desktop/Zynq7010_eink_controller/controller/Z7_Lite/video_dither/video_dither.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log jarvis_dither.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source jarvis_dither.tcl
